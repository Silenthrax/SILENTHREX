...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("SILENTHRAX/assets/Kr.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((1157, 1158))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('SILENTHRAX/assets/font.ttf', size=110)
    welcome_font = ImageFont.truetype('SILENTHRAX/assets/font.ttf', size=60)
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "SILENTHRAX/assets/upic.png"
...
❖𝐌ᴀᴅᴇ  𝐁ʏ [𝐒ɪʟᴇɴᴛʜʀᴀx](https://t.me/SILENTHEX)
""",
