...
from SILENTHRAX.utils.database import add_served_chat, get_assistant, is_active_chat
from SILENTHRAX.misc import SUDOERS
import asyncio
import random
import os
...
async def greet_new_member(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        keyboard = InlineKeyboardMarkup(
            [[InlineKeyboardButton("Join 👋", url="https://t.me/silenthrex")]]
        )
