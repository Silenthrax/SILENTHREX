...
from SILENTHRAX.misc import _boot_
from SILENTHRAX.plugins.sudo.sudoers import sudoers_list
...
from SILENTHRAX.utils.decorators.language import LanguageStart
from SILENTHRAX.utils.formatters import get_readable_time
from SILENTHRAX.utils.inline import help_pannel, private_panel, start_panel
            ...
            if member.id == app.id:
                ...
                if message.chat.id in await blacklisted_chats():
                    await message.reply_text(
                        _["start_5"].format(
                            app.mention,
                            f"https://t.me/LISA_UFC_BOT?start=sudolist",
                            config.SUPPORT_CHAT,
                        ),
